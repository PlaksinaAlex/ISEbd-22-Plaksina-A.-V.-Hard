...
namespace Lab1_Plaksina
{
	class Dop_StripIll : Inter_Dop
	{
		...
		private void DrawIlluminatorsTen(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				g.DrawRectangle(pen, _startPosX + 38 + i * 9, _startPosY + 15, 6, 6);
				g.FillRectangle(brushdop, _startPosX + 38 + i * 9, _startPosY + 15, 6, 6);
				g.DrawLine(pen, _startPosX + 41 + i * 9, _startPosY + 15, _startPosX + 41 + i*9, _startPosY + 21);
				g.DrawLine(pen, _startPosX + 38 + i * 9, _startPosY + 18, _startPosX + 44 + i * 9, _startPosY + 18);
			}
		}
		private void DrawIlluminatorsTwenty(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				...
				g.DrawLine(pen, _startPosX + 41 + i * 9, _startPosY + 24, _startPosX + 41 + i * 9, _startPosY + 30);
				g.DrawLine(pen, _startPosX + 38 + i * 9, _startPosY + 27, _startPosX + 44 + i * 9, _startPosY + 27);
			}
		}
		private void DrawIlluminatorsThrity(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 5; i++)
			{
				...
				g.DrawLine(pen, _startPosX + 1 + i * 7, _startPosY + 52, _startPosX + 7 + i * 7, _startPosY + 46);
			    g.DrawLine(pen, _startPosX + 1 + i * 7, _startPosY + 46, _startPosX + 7 + i * 7, _startPosY + 40);
			}
		}
