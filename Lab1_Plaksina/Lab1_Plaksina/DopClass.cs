...
namespace Lab1_Plaksina
{
	class DopClass_Illuminators
	{
		...
		private void DrawIlluminatorsTen(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				g.DrawEllipse(pen, _startPosX + 38 + i * 9, _startPosY + 16, 6, 6);
				g.FillEllipse(brushdop, _startPosX + 38 + i * 9, _startPosY + 16, 6, 6);
			}
		}
		private void DrawIlluminatorsTwenty(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				g.DrawEllipse(pen, _startPosX + 38 + i * 9, _startPosY + 24, 6, 6);
				g.FillEllipse(brushdop, _startPosX + 38 + i * 9, _startPosY + 24, 6, 6);
			}
		}
		private void DrawIlluminatorsThrity(Graphics g, float _startPosX, float _startPosY, Color color)
		{
			...
			for (int i = 0; i < 5; i++)
			{
				g.DrawEllipse(pen, _startPosX + 2 + i * 7, _startPosY + 41, 5, 5);
				g.DrawEllipse(pen, _startPosX + 2 + i * 7, _startPosY + 47, 5, 5);
				g.FillEllipse(brushdop, _startPosX + 2 + i * 7, _startPosY + 41, 5, 5);
				g.FillEllipse(brushdop, _startPosX + 2 + i * 7, _startPosY + 47, 5, 5);
			}
		}
